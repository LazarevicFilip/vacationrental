    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-lg-3 mb-md-0 mb-4">
                ...
                <a class="font-weight-bold text-uppercase" href="{{asset("assets/data/vacationrental.docx")}}">Dokumentacija</a>
            </div>
            <div class="col-md-6 col-lg-3 mb-md-0 mb-4">
            ...
            <div class="col-md-6 col-lg-3 mb-md-0 mb-4">
                ...
                <form action="#" class="subscribe-form">
                    <div class="form-group d-flex">
                        <label for="em"></label>
                        <input type="text" id="em" class="form-control rounded-left" placeholder="Enter email address"/>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-8">
                    <p class="copyright mb-0">
                        ...
                        Copyright &copy; All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib.com</a>
                    </p>
                </div>
