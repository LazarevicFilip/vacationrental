               ...
               <form method="post" action="{{route("vikendice.store")}}" enctype="multipart/form-data">
                   ...
                   <div class="form-row">
                       ...
                       <div class="form-group col-md-5">
                           ...
                           <input type="text" class="form-control" name="address" value="{{old("address") ? old("address") : ""}}">
                           @error("address")<p class="mt-2 alert-danger">{{$message}}</p> @enderror
                       </div>
                       <div class="form-group col-md-2">
                           <label for="square_footage">Povrsina(m<sup>2</sup>):</label>
                           <input type="text" class="form-control" name="square_footage" value="{{old("square_footage") ? old("square_footage") : ""}}">
                   ...
                   <div class="form-row">
                       <div class="form-group col-md-3">
                           ...
                           <input type="text" class="form-control" name="max_guests" value="{{old("max_guests") ? old("max_guests") : ""}}">
                           @error("max_guests")<p class="mt-2 alert-danger">{{$message}}</p> @enderror
                       </div>
                       <div class="form-group col-md-3">
                           <label for="num_rooms">Broj soba:</label>
                           <input type="text" class="form-control" name="num_rooms" value="{{old("num_rooms") ? old("num_rooms") : ""}}">
                           @error("num_rooms")<p class="mt-2 alert-danger">{{$message}}</p> @enderror
                       </div>
                       <div class="form-group col-md-3">
                           <label for="num_wc">Broj kupatila:</label>
                           <input type="text" class="form-control" name="num_wc" value="{{old("num_wc") ? old("num_wc") : ""}}">
                           @error("num_wc")<p class="mt-2 alert-danger">{{$message}}</p> @enderror
                       </div>
                       <div class="form-group col-md-3">
                           <label for="num_beds">Broj kreveta:</label>
                           <input type="text" class="form-control" name="num_beds" value="{{old("num_beds") ? old("num_beds") : ""}}">
                           @error("num_beds")<p class="mt-2 alert-danger">{{$message}}</p> @enderror
                       </div>
                   </div>
                   <div class="form-group">
                       <label for="description">Opis objekta:</label>
                       <textarea class="form-control" name="description" rows="4">{{old("description") ? old("description") : ""}}</textarea>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3  mx-auto">
                            ...
                            <input type="text" class="form-control" name="price" id="price" value="{{old("price")? old("price") : ""}}">
